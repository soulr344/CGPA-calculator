            ...
            >
                ...
                >
                    ...
                    <div className="container p-3 mb-4 rounded-xl border-2 border-gray-300">
                        <span className="block font-medium pb-3">
                            Change Theme
                        </span>
                        <label
                    ...
                    <p className="text-justify mb-4">
                        First of all, select the desired subjects. The top 3
                        subjects are reserved for compulsory subjects (English,
                        Nepali, Maths or Social Studies). The rest 3 are for
                        optional subjects.
                    </p>
                    <p className="text-justify mb-10">
                        Then, select the GPA for all subjects taking note that
                        the GPA for <strong>Theory (TH)</strong> and for{" "}
                        <strong>Internal (IN)</strong> cannot be interchanged.
                        After completing, click the{" "}
                        <strong>&quot;Calculate&quot;</strong> button and your
                        CGPA along with your grade will be displayed.
                    </p>

                    <p className="text-justify mb-4">
                        <strong>Note:</strong> Selecting different subjects
                        and/or inserting values of Theory subjects in Internal
                        field and vice-versa will result in inaccurate results.
                    </p>
                    <p className="text-justify">
                        This is because each subject, along with Theory and
                        Internal have different credit hours. Because of this,
                        misselection of subjects and/or GPAs, will result in
                        inaccurate result (it&apos;s not incorrect tho
                        technically, Garbage In Garbage Out lol).
                    </p>
                    <div className="mt-10">
                        <img
                        ...
                        <div className="ml-1">
                            ...
                            >
                                <svg
                                    ...
                                    height="16"
                                    fill="currentColor"
                                    class="bi bi-globe2 inline mr-3"
                                    viewBox="0 0 16 16"
                                >
                        ...
                        <div className="ml-1">
                            ...
                            >
                                <svg
                                    ...
                                    height="16"
                                    fill="currentColor"
                                    class="bi bi-envelope-fill inline mr-3"
                                    viewBox="0 0 16 16"
                                >
                        ...
                        <div className="ml-1">
                            ...
                            >
                                <svg
                                    ...
                                    height="16"
                                    fill="currentColor"
                                    class="bi bi-github inline mr-3"
                                    viewBox="0 0 16 16"
                                >
