/**
 * Data parsed from official spec provided by NEB.
 ...
 */
export const GRADE_11_SUBJECTS_OPTIONAL = [
  {
    code: "1031",
    name: "Accounting",
    full_marks: "75",
 ...
 */
export const GRADE_11_SUBJECTS_COMPULSORY = [
  {
    code: "0031",
    name: "Com.English",
    full_marks: "75",
 ...
 */
export const GRADE_12_SUBJECTS_OPTIONAL = [
  {
    code: "1041",
    name: "Accounting",
    full_marks: "75",
 ...
 */
export const GRADE_12_SUBJECTS_COMPULSORY = [
  {
    code: "0041",
    name: "Com.English",
    full_marks: "75",
 ...
 * A+ : 4.0
 */
export const GRADES = ["NG", "D", "C", "C+", "B", "B+", "A", "A+"] as const;

/**
 * Array of Grades along with Grade Points.
 */
export const GRADES_DATA = GRADES.reduce<
...
>(
  (acc, curr) => [
    ...acc,
    {
      ...
      gradePoint:
        /**
         * Return 0 if the grade is NG.
         * Grades differ with each other by 0.4,
         * while the initial offset is 1.2.
         *
         * Value inside Math.floor is multiplied by 100
         * and later divided 100 to to get a number with
         * 2 decimal places.
         */
        curr === "NG" ? 0 : Math.floor(GRADES.indexOf(curr) * 40 + 120) / 100,
    },
  ],
  []
);
